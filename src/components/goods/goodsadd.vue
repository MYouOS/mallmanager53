<template>
    ...
    <el-card>
        ...
        <!-- 外层需要表单来传数据发布发起请求 -->
        <el-form label-position="top" label-width="80px" :model="form" style="height:500px;">
            <el-scrollbar style="height:100%">
                ...
                <el-tabs @tab-click="tabChange()" v-model="active" tab-position="left">
                    ...
                    <el-tab-pane name="2" label="商品参数">
                        ...
                        <el-form-item :label="item1.attr_name" v-for="(item1,i) in arrDyparams" :key="i">
                            ...
                            <el-checkbox-group v-model="item1.attr_vals">
                                <el-checkbox border v-for="(item2,i) in item1.attr_vals" :key="i" :label="item2">
                                </el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="4" label="商品图片">
                        <el-form-item>
                            <!-- baseUrl axios发的请求 -->
                            <el-upload action="http://127.0.0.1:8888/api/private/v1/upload" :headers='headers'
                    ...
                    <el-tab-pane name="5" label="商品内容">
                        <el-form-item>
                            <!-- 表单元素 -->
                            <el-button type="primary" @click="addGoods()" style="margin-top: 20px">添加商品</el-button>
                            <!-- 富文本 -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                // attrs 商品的参数（数组），包含 `动态参数` 和 `静态属性` 可以为空  动态参数+静态参数 -> 数组
                form: {
                    gods_name: '',
                    goods_cat: '',
                    goods_price: '',
